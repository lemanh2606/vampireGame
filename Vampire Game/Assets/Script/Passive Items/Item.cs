...
// <summary>
// Base class for both the Passive and the Weapon classes. It is primarily intended to handle weapon evolution, as we want both weapons and passives to be evolved.
// </summary>
...
public abstract class Item : MonoBehaviour
{
    ...
    public virtual void Initialise(ItemData data)
    {
        ...
        // all the catalysts are in the inventory so we can evole.
        evolutionData = data.evolutionData;

        //We have to find a better way to refernce the player inventory.
    ...
    public virtual bool CanEvolve(ItemData.Evolution evolution, int levelUpAmount = 1)
    {
        ...
        foreach (ItemData.Evolution.Config c in evolution.catalysts)
        {
            ...
            if (item == null || item.currentLevel < c.level)
            {
    ...
    public virtual bool DoLevelUp()
    {
        ...
        // Tries to evolve into every listed evolutin of this weapon.
