...
public class PlayerInventory : MonoBehaviour
{
    ...
    public class UpgradeUI
    {
        ...
        public TMP_Text upgradeDescripIconDisplay;
                ...
                if (chosenWeaponUpgrade != null)
                {
                    ...
                    for (int i = 0; i < weaponSlots.Count; i++)
                    {
                        ...
                        if (w != null && w.data == chosenWeaponUpgrade)
                        {
                            ...
                            upgradeOption.upgradeDescripIconDisplay.text = nextLevel.description;
                    ...
                    if (!isLevelUp)
                    {
                        ...
                        upgradeOption.upgradeDescripIconDisplay.text = chosenWeaponUpgrade.baseStats.description; // Apply initial description
            ...
            else if(upgradeType == 2)
            {
                ...
                if (chosenPassiveUpgrade != null)
                {
                    ...
                    if (!isLevelUp) // Spawn a new passive item
                    {
                        ...
                        upgradeOption.upgradeDescripIconDisplay.text = nextLevel.description; // Apply initial description
