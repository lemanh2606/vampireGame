...
public abstract class Weapon : Item
{
    ...
    public struct Stats
    {
        ...
        public Aura auraPrefeab;
        public ParticleSystem hitEffect;
        public Rect spawnVariance;

        [Header("Values")]
        public float lifespan;
        public float damage, damageVariance, area, speed, cooldown,
            projectileInterval, knockback;
    ...
    public override bool DoLevelUp()
    {
        ...
        if (!CanLevelUp())
        {
            Debug.LogWarning(string.Format(
                "Cannot level up (0) to Level (1), nax level of (2) already reached" ,
