...
public class ProjectileWeapon : Weapon
{
    ...
    // rotates the facing of the point by spamAngle.
    protected virtual Vector2 GetSpawnOffset(float spamAngle = 0)
    {
        return Quaternion.Euler(0, 0, spamAngle) * new Vector2(
